...
interface ChallengeService {
    ...
    //DELETE
    @DELETE("/api/v2/challenges/{challengeId}")
    ...
    @GET("/api/v2/challenges/{challengeId}/invitation-code")
    fun get_challengeCode( //챌린지 초대코드 조회
        @Path("challengeId") challengeId: Int
    ): Call<CodeResponse>

    @GET("/api/v2/challenges/{challengeId}/invitation-code-match")
    ...
    fun get_challenge( //챌린지 개별 조회
        @Path("challengeId") challengeId: Int
    ): Call<ChallengeResponse>

    @GET("/api/v2/challenges/search/name")
    ...
    @GET("/api/v2/challenges/search/hashtag")
    ...
    @GET("/api/v2/challenges/example-images")
