        ...
        fun bind(data: Comment) {
            with(binding) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                    binding.commentLayout.setupWith(rootView, RenderEffectBlur()).setBlurRadius(4f)
                } else {
                    binding.commentLayout.setupWith(rootView, RenderScriptBlur(binding.root.context)).setBlurRadius(4f)
                }
