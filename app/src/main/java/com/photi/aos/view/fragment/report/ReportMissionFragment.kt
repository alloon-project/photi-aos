...
import com.photi.aos.databinding.FragmentReportMissionBinding
...
class ReportMissionFragment : Fragment() {
    ...
    private lateinit var binding : FragmentReportMissionBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_report_mission, container, false)
    ...
    fun click(){
        view?.findNavController()?.navigate(R.id.action_reportMissionFragment_to_reportPageFragment)
